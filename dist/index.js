...
const Button = Ye('button')(({
  ...
  borderColor: `${variant === 'secondary' ? colors$1.input.border : variant === 'transparent' ? 'none' : colors$1.button[variant]}`,
  borderRadius: 4,
  ...
  '&:focus': {
    border: `1px solid ${colors$1.input.focus}`,
    boxShadow: `0 0 0 1px ${colors$1.input.focus}`
  },
  '&:hover': {
