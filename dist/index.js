...
var colors = _objectSpread2(_objectSpread2({}, palette), {}, {
  ...
  card: {
    ...
    border: {
      "default": "1px solid ".concat(palette.smoke[50]),
      focus: "2px solid ".concat(palette.azure[800])
    },
    boxShadow: {
...
_objectSpread2({}, defaultTheme$1);

var _templateObject;
styled.createGlobalStyle(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  html {\n    scroll-behavior: smooth;\n    font-size: 14px;\n  }\n  *:focus {\n    outline: 0 !important;\n  }\n  body {\n    background-color: #ebeff3;\n    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica,\n      Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';\n    color: #183247;\n    -webkit-font-smoothing: antialiased;\n  }\n  p {\n    margin-bottom: 0;\n    font-size: 13px;\n    overflow-wrap: break-word;\n    word-wrap: break-word;\n    hyphens: auto;\n  }\n\n  a:hover {\n    text-decoration: none;\n  }\n  hr {\n    margin-top: 15px;\n    border-radius: 5px;\n    margin-bottom: 15px;\n  }\n\n  *, *::before, *::after {\n    box-sizing: border-box;\n  }\n\n  .center{\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n"])));

var _templateObject$1;
var palette$1 = defaultTheme$1.palette,
    colors$1 = defaultTheme$1.colors,
    shadows = defaultTheme$1.shadows,
    gradients = defaultTheme$1.gradients;
var disabledState = {
  primary: {
...
var Button = styled__default['default']('button')(function (_ref) {
  ...
  return _objectSpread2({
    ...
    border: "".concat(variant === 'transparent' ? 'none' : '1px solid'),
    borderColor: "".concat(variant === 'secondary' ? colors$1.input.border : variant === 'transparent' ? 'none' : colors$1.button[variant]),
    borderRadius: 4,
    boxShadow: "".concat(variant === 'transparent' ? 'none' : shadows.input),
    color: variant === 'secondary' ? palette$1.elephant[900] : palette$1.white,
    fontSize: 14,
    fontWeight: 500,
    height: "".concat(size === 'mini' ? '24px' : '32px'),
    marginRight: mr,
    padding: "".concat(iconOnly ? '4px' : '6px 12px'),
    '&:disabled': _objectSpread2({
      opacity: 0.4,
      pointerEvents: 'none',
      cursor: 'not-allowed'
    }, disabledState[variant]),
    '&:focus': {
      border: "1px solid ".concat(colors$1.input.focus),
      boxShadow: "0 0 0 1px ".concat(colors$1.input.focus)
    },
    '&:hover': {
      background: hoverBg ? hoverBg : colors$1.button[variant]
    },
    svg: {
      marginRight: "".concat(iconOnly ? '0' : '7px')
    }
  }, customStyle);
}, space, layout, position, background, border, typography, color, flexbox, shadow);
Button.defaultProps = {
  variant: 'secondary',
  size: 'normal'
};
Button.propTypes = {
  variant: PropTypes__default['default'].oneOf(['secondary', 'primary', 'danger', 'transparent']),
  size: PropTypes__default['default'].oneOf(['normal', 'mini'])
};
var LoadingButton = styled__default['default'](Button)(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  min-width: ", ";\n  .loader {\n    width: 16px;\n    height: 16px;\n    animation: spin 1s linear infinite;\n\n    svg {\n      path {\n        fill: ", ";\n      }\n    }\n  }\n\n  @keyframes spin {\n    from {\n      transform: rotate(0deg);\n    }\n    to {\n      transform: rotate(360deg);\n    }\n  }\n"])), function (props) {
...
var Avatar = styled__default['default'].span(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  height: 48px;\n  width: 48px;\n  border-radius: 999px;\n  display: inline-flex;\n  justify-content: center;\n  align-items: center;\n  > * {\n    width: 100%;\n    height: 100%;\n    border-radius: 999px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n  ", ";\n  ", ";\n  ", "\n"])), space, layout, color);

var _templateObject$3;
var colors$2 = defaultTheme$1.colors;
var Badge = styled__default['default'].span(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  height: 16px;\n  display: inline-flex;\n  justify-content: center;\n  align-items: center;\n  font-weight: 600;\n  font-size: 12px;\n  line-height: 14px;\n  text-align: center;\n  border-radius: 10px;\n  padding: 1px 8px;\n  ", ";\n  ", ";\n  ", ";\n  ", ";\n  ", ";\n"])), function (_ref) {
  var inverted = _ref.inverted,
      type = _ref.type;
  return inverted ? {
    color: colors$2.badge[type],
    background: colors$2.badge.invert[type]
  } : {
    color: colors$2.white,
    background: colors$2.badge[type]
  };
}, function (_ref2) {
  ...
  var badgeTheme = colors$2.badge[type];
  var subTheme = isActive ? 'active' : 'inActive';
  return {
...
Badge.propTypes = {
  type: PropTypes__default['default'].oneOf(['primary', 'critical', 'new', 'neutral', 'dark']),
  isActive: PropTypes__default['default'].bool
};

var _templateObject$4;
var Box = styled__default['default'].div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n\n\n  &.cursor-pointer {\n    cursor: pointer;\n  }\n"])), space, typography, color, layout, flexbox, position, background, border, borderColor, shadow);

var _templateObject$5, _templateObject2;
styled__default['default'].ul(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n"])));
styled__default['default'].li(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  padding-right: 6px;\n  a {\n    padding-right: 6px;\n  }\n  span {\n    position: relative;\n    top: 1px;\n  }\n"])));

var _templateObject$6;
var colors$3 = defaultTheme$1.colors;
styled__default['default'].button(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  width: 2rem;\n  height: 2rem;\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  padding: 0;\n  span {\n    width: 2rem;\n    height: 0.25rem;\n    background: ", ";\n    border-radius: 10px;\n    transition: all 0.3s linear;\n    position: relative;\n    transform-origin: 1px;\n    :first-child {\n      transform: ", ";\n    }\n    :nth-child(2) {\n      opacity: ", ";\n      transform: ", ";\n    }\n    :nth-child(3) {\n      transform: ", ";\n    }\n  }\n"])), function (_ref) {
  var open = _ref.open;
  return open ? colors$3.burgerBGOpen : colors$3.burgerBGClose;
}, function (_ref2) {
  var open = _ref2.open;
...
var colors$4 = defaultTheme$1.colors;
var Card = styled__default['default'].div(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n  padding: 20px 32px 32px;\n  position: relative;\n  border: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n  display: inline-flex;\n  flex-direction: column;\n  opacity: ", ";\n  pointer-events: ", ";\n  cursor: ", ";\n  height: 276px;\n  &:hover {\n    box-shadow: 0px 2px 16px rgba(18, 52, 77, 0.16);\n  }\n  &:focus-within {\n    border: ", ";\n    box-shadow: ", ";\n  }\n  ", "\n\n  ", ";\n  ", ";\n  ", ";\n"])), function (props) {
  return colors$4.card.border["default"];
}, function (props) {
  return props.borderRadius || '12px';
}, function (props) {
  return colors$4.card.boxShadow["default"];
}, function (props) {
  ...
  return colors$4.card.border.focus;
}, function (props) {
  return colors$4.card.boxShadow.focus;
}, function (props) {
  return props.isSelected && {
    border: colors$4.card.border.focus,
    boxShadow: colors$4.card.boxShadow.focus
  };
}, flex, space, layout);
Card.defaultProps = {
  disabled: false,
...
var SvgCloseIcon = function SvgCloseIcon(props) {
  return /*#__PURE__*/React__default['default'].createElement("svg", _extends({
    ...
    id: "Close-icon_svg__b",
    fill: "#fff"
  }, /*#__PURE__*/React__default['default'].createElement("use", {
    xlinkHref: "#Close-icon_svg__a"
  })), /*#__PURE__*/React__default['default'].createElement("use", {
    fill: "#000",
    fillRule: "nonzero",
    xlinkHref: "#Close-icon_svg__a"
...
var StyledMenu = styled__default['default'].div(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  background: #fff;\n  transform: ", ";\n  height: ", ";\n  text-align: left;\n  position: absolute;\n  top: ", ";\n  right: ", ";\n  z-index: 99999999;\n  transition: transform 0.3s ease-in-out;\n  min-width: ", ";\n  border: 1px solid #ebeff3;\n  @media (max-width: 576px) {\n    width: 100%;\n  }\n  a {\n    font-size: 2rem;\n    text-transform: uppercase;\n    padding: 2rem 0;\n    font-weight: bold;\n    letter-spacing: 0.5rem;\n    color: #0d0c1d;\n    text-decoration: none;\n    transition: color 0.3s linear;\n    @media (max-width: 576px) {\n      font-size: 1.5rem;\n      text-align: center;\n    }\n    &:hover {\n      color: #343078;\n    }\n  }\n  .drawer-close-icon {\n    ", ";\n    position: absolute;\n    z-index: 999999999999;\n    top: 10px;\n    left: 10px;\n    cursor: pointer;\n  }\n"])), function (_ref) {
  var open = _ref.open;
  return open ? 'translateX(0)' : 'translateX(100%)';
}, function (_ref2) {
  var isCoditionDrawer = _ref2.isCoditionDrawer;
  return isCoditionDrawer ? 'calc(100vh - 125px)' : '100vh';
}, function (_ref3) {
  var isCoditionDrawer = _ref3.isCoditionDrawer;
  return isCoditionDrawer ? '125px' : '0';
}, function (_ref4) {
  var isCoditionDrawer = _ref4.isCoditionDrawer;
  return isCoditionDrawer ? '10px' : '0';
}, function (_ref5) {
  var isCoditionDrawer = _ref5.isCoditionDrawer;
  return isCoditionDrawer ? '648px' : '364px';
}, function (_ref6) {
  var isCoditionDrawer = _ref6.isCoditionDrawer;
  return isCoditionDrawer ? 'display:none' : '';
});
...
var DrawerMenu = function DrawerMenu(_ref) {
  var open = _ref.open,
      ...
      disableCross = _ref.disableCross,
      props = _objectWithoutProperties(_ref, ["open", "setOpen", "children", "disableCross"]);

  return /*#__PURE__*/React__default['default'].createElement(StyledMenu, _extends({
    open: open
  }, props), !disableCross ? /*#__PURE__*/React__default['default'].createElement(SvgCloseIcon, {
...
var Drawer = function Drawer(_ref) {
  var children = _ref.children,
      ...
      _ref$isCoditionDrawer = _ref.isCoditionDrawer,
      isCoditionDrawer = _ref$isCoditionDrawer === void 0 ? false : _ref$isCoditionDrawer,
      _ref$modalelement = _ref.modalelement,
      modalelement = _ref$modalelement === void 0 ? '' : _ref$modalelement,
      _ref$customStyles = _ref.customStyles,
      customStyles = _ref$customStyles === void 0 ? {} : _ref$customStyles,
      _ref$disableCross = _ref.disableCross,
      disableCross = _ref$disableCross === void 0 ? false : _ref$disableCross;

  var _useState = React.useState(showDrawer),
      _useState2 = _slicedToArray(_useState, 2),
      open = _useState2[0],
      setOpen = _useState2[1];

  var menuId = 'main-menu';
  var modalRoot = document.getElementById(modalelement);
  ...
  return /*#__PURE__*/ReactDOM__default['default'].createPortal( /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(DrawerMenu, {
    open: open,
    setOpen: setOpen,
    id: menuId,
...
var DropDownStyled = styled__default['default']('div')(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 4px;\n  width: 32px;\n  height: 32px;\n  background: ", ";\n  &:hover {\n    background: ", ";\n  }\n"])), function (_ref) {
  var isOpen = _ref.isOpen;
  return isOpen ? colors.card.bg : 'transparent';
}, function (props) {
  return colors.card.bg;
});
styled__default['default'](Box)(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  background: ", ";\n  box-shadow: 0px 0px 16px rgba(18, 52, 77, 0.16);\n  border-radius: 4px;\n  position: absolute;\n  padding: 12px;\n  width: max-content;\n  z-index: 2;\n  div:not(:first-child) {\n    margin-top: 2px;\n  }\n  ", "\n"])), function (props) {
  return colors.white;
}, position);
styled__default['default'].div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  &:hover {\n    background-color: ", ";\n  }\n  color: ", ";\n  position: relative;\n  font-weight: 500;\n  cursor: pointer;\n  padding: 7px 12px 7px 8px;\n  font-size: 14px;\n  border-radius: 4px;\n  line-height: 1.3;\n  word-break: break-word;\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  cursor: pointer;\n"])), function (props) {
  return colors.card.optionBg;
}, function (_ref2) {
  _ref2.theme;
...
var StyledSVG = styled__default['default'].svg(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n  transform: ", ";\n  ", "\n"])), function (_ref) {
  var _ref$arrow = _ref.arrow,
      arrow = _ref$arrow === void 0 ? 'down' : _ref$arrow;
  return angles[arrow];
}, space);
var Chevron = function Chevron(props) {
  return /*#__PURE__*/React__default['default'].createElement(StyledSVG, _extends({
    width: "12",
    height: "12",
    viewBox: "0 0 10 6",
    fill: "none",
...
var StyledSVG$1 = styled__default['default'].svg(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral(["\n  ", "\n"])), space);

var Ellipse = function Ellipse(props) {
  return /*#__PURE__*/React__default['default'].createElement(StyledSVG$1, _extends({
    width: "16",
    height: "4",
    viewBox: "0 0 16 4",
    fill: "none",
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M1.55907 3.24628e-05C0.931649 -0.00401547 0.363757 0.370816 0.120845 0.949315C-0.122067 1.52782 0.00798309 2.19571 0.450205 2.64081C0.892427 3.0859 1.55947 3.22027 2.13953 2.98111C2.71959 2.74194 3.09809 2.17649 3.0981 1.54906C3.09812 0.697443 2.41066 0.00552676 1.55907 3.24628e-05ZM16 1.54906C16 2.40456 15.3065 3.09809 14.451 3.09809C13.5955 3.09809 12.9019 2.40456 12.9019 1.54906C12.9019 0.693554 13.5955 3.04984e-05 14.451 3.04984e-05C15.3065 3.04984e-05 16 0.693554 16 1.54906ZM6.456 1.54906C6.456 0.693554 7.14952 3.04984e-05 8.00503 3.04984e-05C8.85826 0.00548265 9.5486 0.695822 9.55406 1.54906C9.55406 2.40456 8.86053 3.09809 8.00503 3.09809C7.14952 3.09809 6.456 2.40456 6.456 1.54906Z",
    fill: "black"
  }));
};
...
styled__default['default'](StyledSVG$1)(_templateObject$c || (_templateObject$c = _taggedTemplateLiteral(["\n  transform: ", ";\n"])), function (_ref) {
  var _ref$angle = _ref.angle,
      angle = _ref$angle === void 0 ? 'down' : _ref$angle;
...
var Dropdown = function Dropdown(_ref) {
  ...
  var handleDropClick = function handleDropClick(e) {
    e.stopPropagation();
    setIsOpen(!isOpen);
  };
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ref: node
  }, /*#__PURE__*/React__default['default'].createElement(DropDownStyled, {
    onClick: handleDropClick,
    isOpen: isOpen
  }, /*#__PURE__*/React__default['default'].createElement(Ellipse, null)), isOpen ? /*#__PURE__*/React__default['default'].createElement("div", null, children) : null);
};
...
Dropdown.propTypes = {
  ...
  setIsOpen: PropTypes__default['default'].func.isRequired,
  children: PropTypes__default['default'].node
};

var _templateObject$d;
styled__default['default'].div(_templateObject$d || (_templateObject$d = _taggedTemplateLiteral(["\n  background: ", ";\n  border: 1px solid ", ";\n  border-radius: 4px;\n  padding: 8px;\n  margin: 20px 0 12px 0;\n  color: ", ";\n\n  svg {\n    path {\n      fill: ", ";\n    }\n  }\n\n  .message-label-info {\n    display: flex;\n    align-items: center;\n    .message-form-subtitle {\n      padding-left: 8px;\n      padding-right: 20px;\n    }\n  }\n"])), function (props) {
  return props.warning ? '#ffecf0' : '#e5f2fd';
}, function (props) {
  return props.warning ? '#ffd0d6' : '#bbdcfe';
}, function (props) {
  return props.warning ? '#d72d30' : '#183247';
}, function (props) {
  return props.warning ? '#d72d30' : '#183247';
});
...
var Modal = function Modal(_ref) {
  ...
  return /*#__PURE__*/ReactDOM__default['default'].createPortal( /*#__PURE__*/React__default['default'].createElement("div", null, overlay ? /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
      background: '#12344D',
      width: '100%',
      height: '100vh',
...
Modal.propTypes = {
  ...
  modalStyle: PropTypes__default['default'].object,
  modalRootId: PropTypes__default['default'].string,
...
var AutosizeInput = function (_Component) {
	...
	_createClass(AutosizeInput, [{
		...
		value: function render() {
			...
			var wrapperStyle = _extends$3({}, this.props.style);
			if (!wrapperStyle.display) wrapperStyle.display = 'inline-block';

			var inputStyle = _extends$3({
				boxSizing: 'content-box',
				width: this.state.inputWidth + 'px'
			}, this.props.inputStyle);

			var inputProps = _objectWithoutProperties$2(this.props, []);
			...
			return _react2.default.createElement(
				...
				this.renderStyles(),
				_react2.default.createElement('input', _extends$3({}, inputProps, { ref: this.inputRef })),
...
var loadingDotAnimations = keyframes(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral$1(["\n  0%, 80%, 100% { opacity: 0; }\n  40% { opacity: 1; }\n"])));
...
var GroupHeading = function GroupHeading(props) {
  ...
  return jsx("div", _extends$2({
    css: getStyles('groupHeading', _objectSpread2$1({
      theme: theme
    }, cleanProps)),
    className: cx({
      'group-heading': true
...
var Input = function Input(_ref2) {
  ...
  return jsx("div", {
    css: getStyles('input', _objectSpread2$1({
      theme: theme
    }, props))
  }, jsx(_default, _extends$2({
    className: cx({
      input: true
    }, className),
    inputRef: innerRef,
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _this.onChange = function (newValue, actionMeta) {
      ...
      onChange(newValue, _objectSpread2$1(_objectSpread2$1({}, actionMeta), {}, {
        name: name
      }));
    };
    ...
    _this.announceAriaLiveContext = function (_ref3) {
      ...
      _this.setState({
        ariaLiveContext: instructionsAriaMessage(event, _objectSpread2$1(_objectSpread2$1({}, context), {}, {
  ...
  _createClass$1(Select, [{
    ...
    value: function renderMenu() {
      ...
      var menuElement = /*#__PURE__*/React__default['default'].createElement(MenuPlacer, _extends$2({}, commonProps, menuPlacementProps), function (_ref6) {
        var ref = _ref6.ref,
...
var _templateObject$f, _templateObject2$2;
var colors$6 = defaultTheme$1.colors,
    shadows$1 = defaultTheme$1.shadows,
    fontWeight$1 = defaultTheme$1.fontWeight,
    fontSizes$1 = defaultTheme$1.fontSizes;
var StyledSelect = styled__default['default'].div(_templateObject$f || (_templateObject$f = _taggedTemplateLiteral(["\n  width: ", ";\n  ", ";\n  ", ";\n  .freshui-select__control {\n    cursor: pointer;\n    display: flex;\n    border-radius: 4px;\n    border: 1px solid ", ";\n    background-color: ", ";\n    color: ", ";\n    font-size: 14px;\n    line-height: 20px;\n    min-height: 32px;\n    box-shadow: ", ";\n    ::placeholder {\n      color: ", ";\n    }\n    &:hover {\n      border: 1px solid ", ";\n    }\n    &:focus {\n      border: 1px solid ", ";\n      box-shadow: 0 0 0 1px ", ";\n    }\n\n    ", "\n  }\n\n  .freshui-select__control--menu-is-open {\n    border: 1px solid ", ";\n    box-shadow: 0 0 0 1px ", ";\n    ", "\n  }\n  .freshui-select__menu {\n    z-index: 3;\n    padding: 0 8px;\n    max-height: 250px;\n    width: ", ";\n    ", "\n    .freshui-select__menu-list {\n      max-height: 250px;\n      padding: 7px;\n    }\n  }\n\n  .freshui-select__loading-indicator {\n    position: absolute;\n    left: 8px;\n    color: ", ";\n  }\n\n  .freshui-select__placeholder {\n    color: ", ";\n    margin-left: 2px;\n    margin-right: 2px;\n    position: absolute;\n    top: 50%;\n    transform: translateY(-50%);\n    box-sizing: border-box;\n    font-weight: ", ";\n  }\n\n  .freshui-select__group-heading {\n    padding-left: 8px;\n    font-weight: ", ";\n    font-size: ", ";\n  }\n\n  .freshui-select__group {\n    padding-bottom: 0px;\n    padding-top: 15px;\n  }\n\n  .freshui-select-error {\n    .freshui-select__control {\n      border: 1px solid ", ";\n      color: ", ";\n\n      &:hover {\n        border: 1px solid ", ";\n        box-shadow: inset 0 0 4px 0 ", ";\n      }\n      .freshui-select__single-value {\n        color: ", ";\n      }\n    }\n\n    .freshui-select__placeholder {\n      color: ", ";\n    }\n  }\n\n  .glyphicon-menu-down,\n  .glyphicon-menu-up {\n    font-size: 9px;\n    font-weight: bold;\n    margin-right: 8px;\n  }\n"])), function (props) {
  return props.width || '200px';
}, space, layout, function (_ref) {
  _ref.theme;
  return colors$6.input.border;
}, function (_ref2) {
  _ref2.theme;
  return colors$6.white;
}, function (_ref3) {
  _ref3.theme;
  return colors$6.text.primary;
}, function (_ref4) {
  _ref4.theme;
  return shadows$1.input;
}, function (_ref5) {
  _ref5.theme;
  return colors$6.input.placeholder;
}, function (_ref6) {
  _ref6.theme;
  return colors$6.input.hover;
}, function (_ref7) {
  _ref7.theme;
  return colors$6.input.focus;
}, function (_ref8) {
  _ref8.theme;
  return colors$6.input.focus;
}, function (props) {
  return props.isDisabled ? "border: 1px solid ".concat(colors$6.input.disabled, ";\n    background-color: ").concat(colors$6.input.shadow, ";cursor: not-allowed;") : '';
}, function (_ref9) {
  _ref9.theme;
  return colors$6.input.focus;
}, function (_ref10) {
  ...
  return props.isBtnClick ? 'margin: 12px;' : '';
}, function (props) {
  return props.width || '200px';
}, function (props) {
  return props.isBtnClick ? 'margin-top: 12px; border-radius: 0 0 4px 4px;' : '';
}, function (props) {
  return colors$6.text.primary;
}, function (props) {
  return colors$6.input.placeholder;
}, function (props) {
  return fontWeight$1.normal;
}, function (props) {
  return fontWeight$1.semibold;
}, function (props) {
  return fontSizes$1.sm;
}, function (_ref11) {
  _ref11.theme;
  return colors$6.input.danger;
}, function (_ref12) {
  _ref12.theme;
  return colors$6.input.danger;
}, function (_ref13) {
...
var StyledSelectOption = styled__default['default'].div(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n  &:hover {\n    background-color: ", ";\n  }\n  color: ", ";\n  background-color: ", ";\n  position: relative;\n  font-weight: 500;\n  cursor: pointer;\n  padding: 7px 12px 7px 8px;\n  font-size: 14px;\n  border-radius: 4px;\n  line-height: 1.3;\n  margin: 5px 0;\n  word-break: break-word;\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  word-break: keep-all;\n  ", "\n"])), function (props) {
  return props.isSelected ? '#e5f2fd' : '#ebeff3';
}, function (_ref17) {
  _ref17.theme;
  return colors$6.input.primary;
}, function (props) {
  return props.isSelected ? '#e5f2fd' : '#fff';
}, function (props) {
  return props.isGroupOption ? 'padding-left: 16px;' : '';
});
...
var Select$1 = function Select(_ref) {
  var options = _ref.options,
      ...
      customValueContainer = _ref.customValueContainer,
      customSelectedContainer = _ref.customSelectedContainer,
      setSelectedValue = _ref.setSelectedValue,
      menuIsOpen = _ref.menuIsOpen,
      restProps = _objectWithoutProperties(_ref, ["options", "selectedValue", "errors", "touched", "onChange", "onBlur", "label", "submitCount", "fieldName", "isSearchable", "placeholder", "styles", "mandatory", "autoFocus", "isDisabled", "isLoading", "customValueContainer", "customSelectedContainer", "setSelectedValue", "menuIsOpen"]);

  return /*#__PURE__*/React__default['default'].createElement(StyledSelect, _extends({
    isDisabled: isDisabled,
    style: styles,
    isSearchable: isSearchable
  }, restProps, {
  ...
  }, label, mandatory ? /*#__PURE__*/React__default['default'].createElement("p", {
    style: {
      color: 'red'
    }
  }, "*") : null) : null, /*#__PURE__*/React__default['default'].createElement(index, {
    className: submitCount && submitCount > 0 && errors[fieldName] ? 'freshui-select-error' : '',
    placeholder: placeholder,
    isSearchable: isSearchable,
    ...
    onBlur: function onBlur() {
      return _onBlur(fieldName, true);
    },
    value: setSelectedValue ? setSelectedValue(selectedValue) : options.filter(function (option) {
      return option.value === selectedValue;
    }),
    components: {
      Placeholder: function Placeholder(props) {
        return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, !isLoading && /*#__PURE__*/React__default['default'].createElement("span", {
          className: "freshui-select__placeholder"
        }, props.children));
      },
      Option: function Option(props) {
        var data = props.data,
            ...
            innerRef = props.innerRef,
            innerProps = props.innerProps;
        return /*#__PURE__*/React__default['default'].createElement(StyledSelectOption, _extends({
          isSelected: isSelected,
          isFocused: isFocused,
          ref: innerRef,
          isGroupOption: restProps === null || restProps === void 0 ? void 0 : restProps.isGroupOption,
          className: "freshUi-select-option"
        }, innerProps), !isLoading && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, data.image ? /*#__PURE__*/React__default['default'].createElement("span", {
          style: {
            paddingRight: 8
          }
        }, data.image()) : null, customValueContainer ? customValueContainer(data) : null, /*#__PURE__*/React__default['default'].createElement("span", {
          className: "freshUi-select-item"
        }, children)));
      },
      ValueContainer: function ValueContainer(_ref2) {
        var children = _ref2.children,
            getValue = _ref2.getValue,
            props = _objectWithoutProperties(_ref2, ["children", "getValue"]);

        var selectedValue = getValue();
        selectedValue = selectedValue && selectedValue instanceof Array && selectedValue[0] || {};
        return /*#__PURE__*/React__default['default'].createElement(components.ValueContainer, props, !isLoading && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, selectedValue.image ? /*#__PURE__*/React__default['default'].createElement("span", {
          style: {
            paddingRight: 8
          }
        }, selectedValue.image()) : null, customSelectedContainer ? customSelectedContainer(selectedValue) : null, /*#__PURE__*/React__default['default'].createElement("span", null, children)));
      },
      IndicatorSeparator: function IndicatorSeparator() {
        return null;
      },
      DropdownIndicator: function DropdownIndicator(_ref3) {
        var menuIsOpen = _ref3.selectProps.menuIsOpen;

        if (restProps !== null && restProps !== void 0 && restProps.hideDropdownIndicator) {
          return null;
        }

        return /*#__PURE__*/React__default['default'].createElement(Chevron, {
          arrow: menuIsOpen ? 'up' : 'down',
          mx: "8px"
        });
      }
    },
  ...
  }), submitCount > 0 && touched[fieldName] && (Object.keys(errors).length ? /*#__PURE__*/React__default['default'].createElement("span", {
    className: "error"
...
Select$1.propTypes = {
  ...
  errors: PropTypes__default['default'].object,
  ...
  selectedValue: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number]),
  styles: PropTypes__default['default'].object,
  submitCount: PropTypes__default['default'].number,
  touched: PropTypes__default['default'].object // width: PropTypes.string,
...
var StyledTag = styled__default['default'].div(_templateObject$g || (_templateObject$g = _taggedTemplateLiteral(["\n  display: inline;\n  width: fit-content;\n  padding: 5px 8px;\n  border-radius: 4px;\n  line-height: 12px;\n  font-size: 12px;\n  font-weight: 600;\n  border: 1px solid transparent;\n  word-break: keep-all;\n  visibility: ", ";\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (props) {
  return props.visibility ? props.visibility : '';
}, space, typography, layout, flexbox, variant({
  variants: variants
}));
var Tag = function Tag(props) {
  return /*#__PURE__*/React__default['default'].createElement(StyledTag, props);
};
Tag.defaultProps = {
  variant: 'grey'
};
Tag.propTypes = {
  variant: PropTypes__default['default'].oneOf(['grey', 'blue', 'red', 'green', 'yellow', 'normal']),
  visibility: PropTypes__default['default'].string
};

var _templateObject$h, _templateObject2$3;
...
styled__default['default'].a(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral(["\nposition: relative;\ndisplay: inline-block;\n&:hover .tooltiptext {\n    display: block;\n}\n"])));
styled__default['default'].span(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral(["\ndisplay: none;\nwidth: 100px;\nbackground-color: #1d1d1d;\ncolor: #fff;\ntext-align: center;\nborder-radius: 2px;\npadding: 5px 0;\nposition: absolute;\nz-index: 1;\nletter-spacing: 0.1px;\nfont-size: 11px;\n", ";\n&::after {\n    content: \"\";\n    position: absolute;\n    border-width: 5px;\n    border-style: solid;\n    ", ";\n}\n"])), function (props) {
